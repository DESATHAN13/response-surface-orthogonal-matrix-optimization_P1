function Done = Construction3g( Xf, XA, nc, s, fnameD, fnameQ, Qbest, Dbest, which_Dvalue, critical_D )
   ...
   switch s
    case 1
      for i1=1:m
         ...
         D_value1=(10^9)*abs(det(Xm'*Xm))/(nn^p);%Evangelaras
    ...
    case 7
      ...
      for i7=i6+1:m    
         ...
         D_value1=(10^9)*abs(abs(det(Xm'*Xm)))/(nn^p);%Evangelaras
         if which_Dvalue==1
             D_value=D_value1;
         else 
             D_value=D_value2;
